...
<body>
    <header>
        ...
        <nav class="navigacao"  id="navMenu">
            <div class="nav-left">
                <a href="/ARhome" class="active"><i class="fa-solid fa-house"></i></a>
                <a href="/ARestatisticas">إحصائيات</a>
                <a href="/ARentidades">الكيانات</a>
                <a href="/ARrecursos">مراجع مفيدة</a>
                <a href="/ARabout">تعريف عننا</a>
                <a href="/ARcontacto">اتصل بنا</a>
            </div>
            <div class="nav-right">
                <div class="dropdown" style="display: flex; justify-content: left; text-align: left;">
                ...
                @auth
                    ...
                    <form method="POST" action="{{ app()->getLocale() === 'ar' ? route('ARlogout') : route('ARlogout') }}">
                        @csrf
                ...
                @guest
                    <a href="{{ route('ARlogin.form') }}" title="Login">
                        <i class="fa-solid fa-right-to-bracket"></i>
                    </a>

                    <a href="{{ route('ARregistar.form') }}" title="Registar">
...
<footer>
    <p>حقوق الطبع والنشر &copy; 2025 SIDAI - نظام بيانات الهجرة<br>
