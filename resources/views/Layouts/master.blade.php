...
<head>
    ...
    <header>
        ...
        <nav class="navigacao" id="navMenu">
            ...
            <div class="nav-right">
                <div class="dropdown">
                    <a href="#" title="Idioma" class="dropdown-toggle" id="langToggle">
                ...
                @guest
                    <!-- Login -->
                    <a href="{{ route('login.form') }}" title="Login">
                        <i class="fa-solid fa-right-to-bracket"></i>
                    </a>

                    <!-- Registar -->
                    <a href="{{ route('registar.form') }}" title="Registar">
...
<footer>
    <p>Copyright &copy; 2025 SIDAI - Sistema de dados de imigração<br>
